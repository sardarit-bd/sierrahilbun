        ...
        <div className="flex flex-col gap-6 w-full items-center">
          ...
          <div className="w-full max-w-xl mt-6">
            ...
            <form onSubmit={handleSubmit}>
              <div
                className={`
                  bg-white p-1.5 rounded-lg shadow-2xl transition-all duration-300 ease-out
                  flex flex-col md:flex-row items-center gap-2
                  ${isFocused ? 'ring-4 ring-green-500/30 -translate-y-1' : ''}
                `}
              >
                ...
                <button
                  ...
                  className="w-full md:w-auto bg-[#2E7D32] hover:bg-[#1B5E20] disabled:opacity-50 disabled:cursor-not-allowed text-white font-extrabold py-3 md:py-4 px-8 rounded-md transition-all duration-300 flex items-center justify-center gap-2 text-lg shadow-md whitespace-nowrap"
                >
                  {processing ? 'Checking...' : 'Get your plan'}
                  <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-1" />
                </button>
              </div>

              {errors.zip_code && (
                <p className="text-red-300 text-sm mt-3 text-left font-medium">
                  {errors.zip_code}
                </p>
              )}
            </form>
