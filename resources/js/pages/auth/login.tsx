...
const Label = ({ children, htmlFor }: { children: React.ReactNode; htmlFor: string }) => (
    <label htmlFor={htmlFor} className="block text-sm font-bold text-gray-700 uppercase tracking-wide text-xs">
        {children}
    </label>
);
...
export default function Login({ status = '', canResetPassword = true, canRegister = true }: Props) {
                        ...
                        <form onSubmit={submit} className="flex flex-col gap-5">
                                    ...
                                    <div className="flex items-center justify-between">
                                        ...
                                        {canResetPassword && (
                                            <a href={route('password.request')}
                                                className="text-xs font-semibold text-[#2E7D32] hover:text-[#1B5E20] hover:underline transition-colors"
                                                tabIndex={5}>
                                                Forgot password?
                                            </a>
                                        )}
                            ...
                            <div className="relative my-4">
                                ...
                                <div className="relative flex justify-center text-xs uppercase">
                                    <span className="bg-[#FDFBF7] px-2 text-gray-500 font-bold tracking-wider">Or continue with</span>
                                </div>
                            </div>
                            ...
                            {canRegister && (
                                <div className="text-center mt-6 pt-4 border-t border-gray-100">
                                    <p className="text-gray-500 text-sm">
                                        ...
                                        <Link href={route('register')} tabIndex={6} className="font-bold text-lg block mt-1 text-[#2E7D32]">
                                            Create an account
                                        </Link>
                                    </p>
                                </div>
